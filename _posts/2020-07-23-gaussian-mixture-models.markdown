...
In the image below I have plotted the negative log-likelihood (left), a GMM with $$K=2$$ (center), and a GMM with $$K=5$$ (right).

![nll and gmm]({{site.baseurl}}/images/gmm_nll_k2_k5.png){:class="img-responsive"}

As you can see the negative log-likelihood rapidly goes down in the first iterations without any oscillation. The GMM with two components seems to adequately capture most of the variation in the data, while adding more components looks redundant.
